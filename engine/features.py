        ...
        try:
            ...
            if results:
                ...
                if results:
                    ...
                    speak("Opening " + app_name)
                    try:
                        os.system('start ' + quote(app_name))
                    except:
                        speak("not found")
...
def makeCall(name, mobileNo):
    ...
    speak("Calling "+name)
    command = 'adb -e shell am start -a android.intent.action.CALL -d tel:'+mobileNo
    os.system(command)
...
def sendMessage(message, mobileNo, name):
    ...
    keyEvent(3)
    # open sms app
    tapEvents(145.8, 1308.0)
    #start chat
    tapEvents(618.0, 1228.1)
    # search mobile no
    adbInput(mobileNo)
    #tap on name
    tapEvents(259.6, 491.7)
    # tap on input
    tapEvents(391.5, 802.5)
    #message
    adbInput(message)
    #send
    tapEvents(650, 814.5)
